SET NOCOUNT ON; select top 0 LTRIM(RTRIM(PARTY_ID)) as PARTY_ID,(select DEALER_NUMBER from C_B_DEALER where DEALER_ID=C_B_DEALER.ROWID_OBJECT) DEALER_NO,RELATION_START_DATE,RELATION_END_DATE from C_REL_PARTY_DEALER
